...
const T = {
  ...
  ru: {
    ...
    hero_badge:    '🇹🇭 Запуск в Таиланде',
    hero_h1:       'Не платите агентствам. Находите работу напрямую.',
    hero_h1_em:    'Работодатели платят, чтобы связаться с вами. Для вас — бесплатно навсегда.',
    hero_p:        'ThaiHelper — платформа прямого поиска работы в Таиланде для нянь, репетиторов, поваров, водителей, сиделок и других специалистов. Создайте профиль за 3 минуты — проверенные работодатели найдут вас и свяжутся напрямую. Без посредников. Без комиссий. Вы получаете 100% заработка.',
    hero_cta1:     'Создать бесплатный профиль →',
    hero_cta2:     'Как это работает',
    stat1:         '100% бесплатно для исполнителей',
    stat2:         'Города по всему Таиланду',
    stat3_bold:    'Напрямую',
    stat3:         'Контакт — без посредников',
    trust1:        'Без комиссий агентств — навсегда',
    trust2:        'Ваши данные в безопасности',
    trust3:        'Работает на любом телефоне',
    trust4:        'Работодатели находят вас сами',
    preview_label: 'Ваш профиль',
    preview_title: 'Так семьи видят вас',
    preview_sub:   'Проверенный профессиональный профиль — виден семьям, ищущим помощь в вашем городе.',
    preview_badge: '✓ Проверен',
    preview_exp:   'лет опыта',
    preview_btn:   'Связаться',
    preview_note:  'Только оплатившие и проверенные семьи могут связаться с вами.',
    how_label:     'Как это работает',
    how_title:     '3 шага к работе',
    how_sub:       'Без агентств. Без очередей. Только ваш профиль и прямой контакт с работодателями.',
    step1_h:       'Зарегистрируйтесь бесплатно',
    step1_p:       'Создайте профиль за несколько минут. Укажите опыт, навыки, график и фото.',
    step2_h:       'Вас найдут',
    step2_p:       'Семьи, ищущие домашний персонал в вашем городе, увидят ваш профиль и напишут напрямую.',
    step3_h:       'Начните работать',
    step3_p:       'Общайтесь напрямую, договаривайтесь об условиях и приступайте к работе — без посредников и комиссий.',
    ben_label:     'Почему ThaiHelper',
    ben_title:     'Создано для домашних специалистов',
    ben_sub:       'Мы создали ThaiHelper, потому что нынешняя система не работает. Агентства берут слишком много. Facebook — хаос. Вы заслуживаете лучшего.',
    ben1_h:        'Полностью бесплатно для вас',
    ben1_p:        'Размещение профиля на ThaiHelper бесплатно — навсегда. Платят работодатели, а не вы.',
    ben2_h:        'Серьёзные работодатели',
    ben2_p:        'Только проверенные, оплатившие семьи могут связаться с вами. Никаких случайных людей.',
    ben3_h:        'Тайские и иностранные семьи',
    ben3_p:        'Работайте с тайскими семьями и экспатами из Европы, США, России и других стран — по всему Таиланду.',
    ben4_h:        'Создайте репутацию',
    ben4_p:        'Получайте проверенные отзывы после каждой работы. Сильный профиль — лучшие возможности.',
    ben5_h:        'Работа рядом с домом',
    ben5_p:        'Бангкок, Чиангмай, Пхукет, Паттайя, Ко Самуи — находите работу в вашем городе.',
    ben6_h:        'Вы контролируете всё',
    ben6_p:        'Устанавливайте свои расценки, график и условия. Принимайте только ту работу, которую хотите.',
    cat_label:     'Категории услуг',
    cat_title:     'Кто может зарегистрироваться?',
    cat_sub:       'Домашний персонал, репетиторы, учителя и другие — все добро пожаловать.',
    cat1:          '👶 Няня',
    cat2:          '🏠 Домработница / уборка',
    cat3:          '👨‍🍳 Личный повар',
    cat4:          '🚗 Водитель',
    cat5:          '🌿 Садовник и уход за бассейном',
    cat6:          '🏥 Уход за пожилыми',
    cat7:          '📚 Репетитор / учитель',
    cta_label:     'Присоединяйтесь к ThaiHelper',
    cta_title:     'Готовы найти новую работу?',
    cta_sub:       'Будьте среди первых на платформе. Ранние профили получают приоритетную видимость при запуске.',
    cta_body:      'Займёт около 3 минут. Добавьте фото, опыт и контакты — и мы поможем нужным семьям найти вас.',
    cta_btn:       'Создать бесплатный профиль →',
    cta_note:      'Без банковской карты. Без комиссий. Без подвоха.',
    vid_label:     'Смотрите в действии',
    vid_title:     'Реальные люди. Реальная работа.',
    vid_sub:       'Смотрите, как работает ThaiHelper — от регистрации до первой работы.',
    vid1_title:    'Добро пожаловать в ThaiHelper',
    vid1_sub:      'Краткое знакомство от основателя',
    vid1_badge:    '🇬🇧 Английский',
    vid2_title:    'Как зарегистрироваться',
    vid2_sub:      'Пошаговое руководство для исполнителей',
    vid2_badge:    '🇵🇭 Филиппинский · 🇹🇭 Тайский',
    vid3_title:    'Истории исполнителей',
    vid3_sub:      'Скоро — истории нашего сообщества',
    vid3_badge:    '🎬 Скоро',
...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className={lang === 'th' ? 'lang-th' : lang === 'ru' ? 'lang-ru' : ''}>
        ...
        <section className="provider-cta" id="register">
          <div className="section-inner">
            ...
            <div className="cta-box">
              <div className="cta-text" style={{ textAlign: 'center' }}>
                <p>{t.cta_body}</p>
    ...
    <div className="cookie-banner">
      <span>
        {lang === 'th'
          ...
          : lang === 'ru'
          ? <>Мы используем local storage только для сохранения языка — без отслеживания. Читайте нашу <Link href="/privacy" style={{ color: '#5eead4' }}>Политику конфиденциальности</Link>.</>
      ...
      <button className="cookie-banner-btn" onClick={accept}>
        {lang === 'th' ? 'รับทราบ' : lang === 'ru' ? 'Понятно' : 'Got it'}
      </button>
    </div>
  );
}
